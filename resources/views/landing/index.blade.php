...
@section('content')
{{-- hero page --}}
<section class="hero-section d-flex align-items-center justify-content-center text-white py-5 text-center position-relative">
    <div class="container">
        ...
        <p class="hero-description lead text-light mb-5 px-3 mx-auto">
            Akses koleksi buku terlengkap untuk menemani perjalanan membaca dan belajar kamu.
        </p>
        <a href="#" class="btn btn-light fw-bold px-5 py-3 text-uppercase hero-btn-custom rounded-pill">MULAI MEMBACA</a>
    </div>
</section>
...
{{-- Koleksi Unggulan --}}
<section id="koleksi" class="py-5 my-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6 d-flex flex-column ">
                ...
                <div class="">
                    <h4 class=" fs-4 fw-bold">The Great Gatsby</h4>
                    <p class="text-uppercase letter-spacing-1 mb-4">F. SCOTT FITZGERALD</p>
                    <p class="mb-5 text-secondary max-w-400 lh-16">Kisah klasik tentang kemewahan, ambisi, dan tragedi di era Jazz.</p>
                    <a href="#" class="btn btn-light text-dark fw-bold px-4 py-3 rounded-pill text-uppercase letter-spacing-1" style="font-size: 0.9rem;">PINJAM SEKARANG</a>
                </div>
            </div>
            <div class="col-md-6 text-end pe-md-5">
                <img src="{{ asset('assets/img/Buku1_Mockup.png') }}" alt="Buku Koleksi Unggulan" class="mt-5 img-fluid book-cover-img">
            </div>
        </div>
    </div>
</section>
...
<section id="fitur" class="py-5">
    <div class="container">
        <h3 class="fw-bold mb-5 fs-2">Fitur Elit</h3>
        <div class="d-flex flex-column gap-4">
            <div class="card card-custom bg-dark-custom border-0  rounded text-white p-4">
...
{{-- Testimoni --}}
<section class="testimoni-section py-5 my-5">
    <div class="container">
        <h3 class="fw-bold mb-5 fs-2">Suara dari Pustakawan</h3>
        <div class="row g-4">
            <div class="col-md-4">
...
<section class=" cta-section py-5 bg-white text-dark text-center">
    <div class="container py-5 my-md-4">
        <h2 class="cta-title fw-bold mb-5">Siap Memulai Petualangan <br>Membaca Anda?</h2>
        <a href="#" class="btn btn-dark fw-bold px-5 py-3 text-uppercase rounded-pill shadow-lg btn-cta-custom">DAFTAR SEKARANG</a>
    </div>
</section>
